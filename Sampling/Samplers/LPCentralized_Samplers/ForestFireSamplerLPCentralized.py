...
class ForestFireSamplerLPCentralized(Sampler):
    """
    ...
    def _start_a_fire(self, first_iter):
        """
            ...
            nodes and the burned node will be added to the sample set. Since this is an LPCentralized modification of FF it
            starts the burning at the LP nodes.
        """
        if not first_iter:
