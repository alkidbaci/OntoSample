...
class RandomWalkerJumpsWithPrioritizationSamplerLPCentralized(RandomWalkerWithPrioritizationSampler):
    """
        Implementation of random walker jumps with prioritization sampling LP centralized. Focuses around LP nodes.
    """
    ...
    def sample(self, nodes_number: int, lp_path, dpp=1.0, jump_prob: float = 0.1) -> KnowledgeBase:
        """
