...
class RandomWalkerWithPrioritizationSamplerLPFirst(RandomWalkerWithPrioritizationSampler):
    """
        Implementation of random walker with prioritization sampling LP first. Starts with LP nodes first.
    """
