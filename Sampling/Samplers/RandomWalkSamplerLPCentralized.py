...
class RandomWalkSamplerLPCentralized(Sampler):
    """
        Implementation of random walk sampling learning problem(LP) centralized. Creates a subgraph by walking randomly in
        neighborhood of the LP nodes in the graph.
    """
