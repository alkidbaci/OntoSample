...
from Sampling.Samplers.RandomWalkerWithPrioritizationSampler import Node, RandomWalkerWithPrioritizationSampler
...
class RandomWalkerJumpsWithPrioritizationSampler(RandomWalkerWithPrioritizationSampler):
    """
        Implementation of random walker jumps with prioritization sampling.
    """
